...
if __name__ == '__main__':
    ...
    # s1.add_simple_discount("s1", "store", 10, rule_type="and", p1_name="p1", gle1=">", amount1=3, p2_name="p4", gle2="=", amount2=23)
    # s1.add_simple_discount("s1", "product", 10, "p1", rule_type="and", p1_name="p1", gle1=">", amount1=3, p2_name="p4", gle2="=", amount2=23)
    # s1.connect_discounts("s1", 1, 6, "xor", "basket", 123)
    res = s1.get_discounts("s1")
