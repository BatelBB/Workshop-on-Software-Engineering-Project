...
class test_purchase_policy(unittest.TestCase):
    ...
    def test_auction(self):
        ...
        store = self.service.store_controller.stores.get("burekas gedera")
        # print(store.products_with_special_purchase_policy)
        self.assertTrue("burekas pitriot" in store.products_with_special_purchase_policy.keys(), "failed")
        ...
        self.assertTrue(res.success, "failed")

        self.assertTrue(store.products_quantities.get("burekas pitriot").quantity == 0, "failed")
        store.new_day()
