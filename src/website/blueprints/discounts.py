...
class AddDiscount(FlaskForm):
    discount_type = SelectField('Discount Type', choices=[('store', 'STORE'), ('product', 'PRODUCT'), ('category', 'CATEGORY')])
    ...
    rule_type = SelectField('Rule Type', choices=[("None", "NONE"), ('and', 'AND'), ('or', 'OR'), ('basket', 'BASKET')], default=None)
